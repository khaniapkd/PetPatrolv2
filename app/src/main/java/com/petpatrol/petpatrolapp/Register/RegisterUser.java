...
import com.petpatrol.petpatrolapp.config.Constant;
...
public class RegisterUser extends AppCompatActivity {
    ...
    @BindView(R.id.button2) //@BindView declare sekaligus inisialisasi view dengan menggunakan library ButterKnife
            Button btnRegister;
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(RegisterUser.this, "Berhasil mendaftar, Silahkan login!", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(RegisterUser.this, MainActivity.class)); //panggil login activity
                            finish();
                            //updateUI(user);
                        } else {
