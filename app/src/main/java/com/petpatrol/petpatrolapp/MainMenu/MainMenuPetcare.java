...
public class MainMenuPetcare extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_menu_petcare);
        ...
        for(int i = 0; i < mainGrid.getChildCount(); i++){
            ...
            cardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(MainMenuPetcare.this, "Clicked at index " + finalI, Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
